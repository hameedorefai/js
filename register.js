...
class RegisterManager {
    ...
    async uploadProfilePicture(file) {
        ...
        try {
            ...
            const sasResponse = await fetch(`https://zamayl7.azurewebsites.net/api/UserProfile/generateProfilePictureUploadSas`, {
                method: 'GET',
                headers: {
            ...
            const updateResponse = await fetch(`https://zamayl7.azurewebsites.net/api/UserProfile/ProfilePicture/${guid}`, {
                method: 'PUT',
                headers: {
                    'Authorization': `Bearer ${token}`,
                    'accept': '*/*'
